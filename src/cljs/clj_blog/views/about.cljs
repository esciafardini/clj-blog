...
(defn about []
  [:div.column.is-three-fourths
   [:p "This Blogg was built with Clojure(Script) using the Luminus framework. The front-end is Re-Frame and Reagent, the back-end is a PostgreSQL instance.
       This is my first fully realized & deployed full stack project.  It is meant to be a learning resources for myself and other people who are new to
       Web Development and Functional Programming. I relied heavily on the book Web Development In Clojure (3rd Edition), YouTube (Kelvin Mai & On The Code Again), my co-workers,
